...
<script lang="ts">
	...
	import Component, { Example, Meta } from '$lib/_internal/docs/Component.svelte'
	...
	const examples: Example[] = [
		{
			title: 'Use with icon',
			helper: 'You can use any Icon from any Icon Pack',
			source: ''
			// 			`<script>
...
<Component {meta} {features} {quickstart} {docs} {examples}>
